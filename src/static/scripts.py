...
from src.config import LOCAL_BASE_CHART_PATH, LOCAL_BASE_PANTRY_PATH
from src.wrappers.base.utils.meta import get_file_times
...
def get_directory_meta_data():
    ...
    with open("src/static/meta.py", "w") as file:
