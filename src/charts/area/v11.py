...
#             rx.text(
#                 prefix,
#                 class_name="text-gray-400 text-sm font-medium pl-3 select-none pointer-events-none",
#             )
#         )
...
#             rx.text(
#                 suffix,
#                 class_name="text-gray-400 text-sm font-medium pr-3 select-none pointer-events-none",
#             )
#         )
...
#             "bg-transparent border border-gray-700 rounded-md "
