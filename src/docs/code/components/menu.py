...
def dropdown_menu_content(*children, class_name: str = "", **props):
    ...
    base_classes = (
        ...
        "z-50 min-w-[8rem] overflow-x-hidden overflow-y-auto rounded-md border dark:border-[var(--input)] p-1 shadow-md"
    )
...
def dropdown_menu_separator(class_name: str = "", **props):
    ...
    base_classes = "bg-[var(--border)] -mx-1 my-1 h-px"
...
def dropdown_menu_sub_content(*children, class_name: str = "", **props):
    ...
    base_classes = (
        ...
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 "
        "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 "
        "z-50 min-w-[8rem] overflow-hidden rounded-md border p-1 shadow-lg border dark:border-[var(--input)]"
    )
