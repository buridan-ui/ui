...
def typography_table_header(*children, **props):
    """Table header row"""
    return rx.el.tr(
        *children, class_name="even:bg-[var(--muted)] m-0 border-t p-0", **props
    )
...
def typography_table_head(*children, **props):
    ...
    return rx.el.th(
        *children,
        class_name="border px-4 py-2 text-left font-bold [&[align=center]]:text-center [&[align=right]]:text-right",
        **props,
    )
...
def typography_table_cell(*children, **props):
    ...
    return rx.el.td(
        *children,
        class_name="border px-4 py-2 text-left [&[align=center]]:text-center [&[align=right]]:text-right",
        **props,
    )
