...
#                </svg>"""
#         ),
#         class_name="flex items-center justify-center w-5 h-5 bg-gray-1 text-gray-400 rounded-full"
#     )
...
#         rx.text(
#             text,
#             class_name="text-gray-7" if included else "text-gray-4"
#         ),
...
#             rx.box(
#                 "Most Popular",
#                 class_name="absolute -top-4 left-1/2 transform -translate-x-1/2 bg-blue-600 text-white px-4 py-1 rounded-full text-xs font-semibold"
#             )
#         ),
...
#                 rx.heading(
#                     title,
#                     class_name="text-xl font-bold text-gray-9 mb-2"
#                 ),
#                 rx.text(
#                     description,
#                     class_name="text-gray-6 text-sm mb-6"
#                 ),
...
#                     rx.text(
#                         price,
#                         class_name="text-5xl md:text-6xl font-bold text-gray-9"
#                     ),
#                     rx.text(
#                         price_cents,
#                         class_name="text-xl font-bold text-gray-9"
#                     ),
#                     class_name="flex items-end justify-center"
#                 ),
#                 rx.text(
#                     period,
#                     class_name="text-gray-5 text-center mt-2"
#                 ),
#                 class_name="mb-8"
#             ),
...
#                     rx.text(
#                         "Cancel anytime.",
#                         class_name="text-xs text-gray-5"
#                     ),
#                     rx.text(
#                         "No card required.",
#                         class_name="text-xs text-gray-5"
...
#                         {'bg-blue-6 hover:bg-blue-7 text-white shadow-lg hover:shadow-xl' if is_popular else 'hover:bg-gray-50 text-gray-8 border-2 border-gray-2 hover:border-gray-3'}
#                         dark:{'bg-blue-6' if is_popular else 'bg-neutral-800 dark:hover:bg-neutral-700 dark:text-white dark:border-neutral-600'}
...
#             {'border-blue-2 shadow-xl shadow-blue-100/50' if is_popular else 'border-gray-2 hover:border-gray-3 shadow-lg hover:shadow-xl'}
#             hover:-translate-y-1
#         """
#     )
...
#                     class_name="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-9 text-center mb-4"
#                 ),
#                 rx.text(
...
#                 class_name="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-8 max-w-5xl mx-auto"
#             ),
...
#         ),
#         class_name="py-16 lg:py-24 min-h-screen"
#     )
