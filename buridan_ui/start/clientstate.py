        ...
        rx.box(
            rx.markdown(
                ...
                component_map={
                    ...
                    "table": lambda *c: rx.table.root(
                        *c,
                        variant="ghost",
                        size="2",
                        width="100%",
                    ),
                    "thead": lambda *c: rx.table.header(*c),
                    "tbody": lambda *c: rx.table.body(*c),
                    "tr": lambda *c: rx.table.row(
                        *c,
                        align="center",  # keep this if you like center-align
                    ),
                    "th": lambda t: rx.table.column_header_cell(
                        rx.text(
                            t, size="1", weight="bold", color=rx.color("slate", 11)
                        ),
                    ),
                    "td": lambda t: rx.table.cell(
                        rx.text(t, size="1", weight="regular"),
                    ),
                },
            ),
            class_name="p-4",
