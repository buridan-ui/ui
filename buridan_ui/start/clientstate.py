        ...
        rx.box(
            rx.markdown(
                ...
                component_map={
                    ...
                    "codeblock": lambda c, **props: rx.box(
                        rx.box(
                            rx.code_block(
                                c,
                                language="python",
                    ...
                    "table": lambda *c: rx.box(
                        rx.box(
                            rx.table.root(
                                *c,
                                class_name="min-w-max border-collapse text-sm",
                                border=f"1px dashed {rx.color('gray', 5)}",
                            ),
                    ...
                    "thead": lambda *c: rx.el.thead(*c, class_name="text-sm"),
                    "tbody": lambda *c: rx.el.tbody(*c),
                    "tr": lambda *c: rx.el.tr(
                        *c,
                        class_name="text-sm",
                        border_bottom=f"1px dashed {rx.color('gray', 6)}",
                    ),
                    "th": lambda *c: rx.el.th(
                        *c, class_name="text-left p-2 text-sm font-semibold"
                    ),
                    "td": lambda *c: rx.el.td(
                        *c, class_name="text-left p-2 text-sm text-slate-11"
                    ),
                },
                class_name="size-full",
            ),
            class_name="p-4 size-full",
        )
    ]
